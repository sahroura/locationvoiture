...
<title>Location Auto - Liste des véhicules</title>
...
<ul id="mainNav">
        ...
        <div id="containerHolder">
			<div id="container">
                ...
                <h2><a href="#">ADMINISTRATION</a> &raquo; <a href="#" class="active">Liste des véhicules</a></h2>
                <div id="main">                    
				<form id="form1" name="form1" method="post" action="ContVehicule?page=/modif1">
                        <table width="638" border="1">
                          <tr>
                            <td width="36">&nbsp;</td>
                            <td width="155"><strong>Modèle</strong></td>
                            <td width="168"><strong>Nembre de places</strong></td>
                            <td width="393"><strong>Catégorie</strong></td>
                          </tr>
                          <%
	          				Vehiculedao vehicules= new Vehiculedao();				
		                	%>

							<%
		                        int i = 0;
						    	while (i < vehicules.listevehicules(null).size()) {
								Vehicule _vehi= new Vehicule();
								_vehi = vehicules.listevehicules(null).get(i);
							%>          
                            <tr>
                              <td>
                              ...
                              %>
                              <%=libcat.categories(_vehi.getcodecat()).get(0).getlibelle() %>
                              </td>
                            </tr>
                            <%
		i++;
		...
		%>
          ...
          <p>&nbsp;</p>
                          <p>
                            <label>
                            <input type="submit" name="nouveau" id="nouveau" value="Nouveau véhicule" />
                            </label>
                            <label>

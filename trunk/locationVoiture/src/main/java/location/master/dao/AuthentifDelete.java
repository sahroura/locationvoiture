...
public void supprimer(int id_user) {
		...
		try {
			...
			selectStatement.executeUpdate(Requetes.REQUETE_DEL_USER(id_user));
			...
			e.getCause();
			System.err
					.println("Un probleme de connexion est sourvenu, vérfier la chaine de connexion 1");
		}
}

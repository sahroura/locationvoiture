...
public void supprimer(String cin) {
		...
		try {
			...
			selectStatement.executeUpdate(Requetes.REQUETE_SUPPRIMER_CLIENT(cin));
			...
			e.getCause();
			System.err
					.println("Un probleme de connexion est sourvenu, vérfier la chaine de connexion 9");
		}
}

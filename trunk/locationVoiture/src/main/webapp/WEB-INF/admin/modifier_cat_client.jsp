...
<ul id="mainNav">
        ...
        <div id="containerHolder">
			<div id="container">
                ...
                <h2><a href="#">ADMINISTRATION</a> &raquo; <a href="#" class="active">Modifier une catégorie client</a></h2>
<div id="main">
                        <form id="form1" name="form1" method="post" action="ContCatClient?page=/modif2">
                          <table width="200" border="1">
                            <tr>
                              <td width="132"><div align="right">
                                <%Integer code=(Integer)request.getAttribute("code"); %>
                                <%String cat=(String)request.getAttribute("cat"); %>
                                <%Float tauxremise=(Float)request.getAttribute("tauxremise"); %>
                                Catégorie</div></td>
                              <td width="632"><input type="text" name="cat" id="cat" value=<%=cat %> /></td>
                            </tr>
                            <tr>
                              <td><div align="right">Taux de remise</div></td>
                              <td><input type="text" name="tauxremise" id="tauxremise" value=<%=tauxremise %> /> %</td>
                            </tr>
                          </table>
                          <p>&nbsp;</p>
                          <p>

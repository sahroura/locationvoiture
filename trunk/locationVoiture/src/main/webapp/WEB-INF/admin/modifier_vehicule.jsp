...
<title>Location Auto - Modifier véhicule</title>
			...
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                   	  ...
                   	  <li><a href="ContCatClient?page=/WEB-INF/admin/vehicule.jsp" class="active">Liste des véhicules</a></li>
                ...
                <h2><a href="#">ADMINISTRATION</a> &raquo; <a href="#" class="active">Modifier les informations d'un véhicule</a></h2>
              <div id="main">  
<form id="form1" name="form1" method="post" action="ContVehicule?page=/modif2">
                          <table width="573" border="1">
                            ...
                            Vehiculedao vehic = new Vehiculedao();
                            vehi=vehic.listevehicules(immatr).get(0);
							%>
                              Immatriculation</div></td>
                              <td width="637"><input type="text" name="immatr" id="immatr" value=<%=vehi.getimmatricule() %> />
                              <input type="hidden" name="immatr1" value=<%=vehi.getimmatricule() %> /></td>
                            </tr>
                            <tr>
                              <td><div align="right">Modèle</div></td>
                              <td><input type="text" name="modele" id="modele" value=<%=vehi.getmodele() %> /></td>
                            </tr>
                            <tr>
                              <td><div align="right">Nombre de places</div></td>
                              <td><input type="text" name="nbre_place" id="nbre_place" value=<%=vehi.getnbreplace() %> /></td>
                            </tr>
                            <tr>
                              <td><div align="right">Catégorie</div></td>
                              <td><select name="cat" id="cat">
                                <%
											CatVehiculedao listeCat= new CatVehiculedao();				
												  %>
                                <%
													int i = 0;
                                ...
                                <option value='<%=_Cat.getcode() %>'
                                                   <%
                                                   String cat;
                                                   if(_Cat.getcode()==vehi.getcodecat())
                                                   {
                                                	   %>
                                                	   <%="selected='selected'" %>
                                                    <%} %>

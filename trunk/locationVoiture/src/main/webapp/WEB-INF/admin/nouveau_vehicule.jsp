...
<ul id="mainNav">
        ...
        <div id="containerHolder">
			<div id="container">
                ...
                <h2><a href="#">ADMINISTRATION</a> &raquo; <a href="#" class="active">Nouveau véhicule</a></h2>
                <div id="main"> 
            <form id="form1" name="form1" method="post" action="ContVehicule?page=/nouveau">
                          <table width="200" border="1">
                            <tr>
                              <td width="120"><div align="right">Immatriculation</div></td>
                              <td width="644"><input type="text" name="immatr" id="immatr" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td><input type="text" name="nbre_place" id="nbre_place" /></td>
                            </tr>
                            <tr>
                              ...
                              <td><select name="cat" id="cat" >
                                ...
                                <%
												  ...
												  %>
                                <option value='<%=_Cat.getcode() %>' ><%=_Cat.getlibelle() %></option>
                                <%
													i++;
													}
												  %>

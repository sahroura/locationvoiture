...
<title>Location Auto - Nouvelle catégorie client</title>
...
<ul id="mainNav">
        ...
        <div id="containerHolder">
			<div id="container">
                ...
                <h2><a href="#">ADMINISTRATION</a> &raquo; <a href="#" class="active">Nouvelle Catégorie client</a></h2>
          <div id="main">
                        <form id="form1" name="form1" method="post" action="ContCatClient?page=/nouvelle">
                          <table width="200" border="1">
                            <tr>
                              <td width="106"><div align="right">Catégorie</div></td>
                              <td width="658"><input type="text" name="cat" id="cat" /></td>
                            </tr>
                            <tr>
                              <td><div align="right">Taux de remise</div></td>
                              <td><input type="text" name="tauxremise" id="tauxremise" /> %</td>
                            </tr>
                          </table>
                          <label></label>
                          <p>

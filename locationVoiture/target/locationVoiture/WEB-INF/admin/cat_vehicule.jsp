...
<title>Location Auto - Catégories des véhicules</title>
...
<ul id="mainNav">
        ...
        <div id="containerHolder">
			<div id="container">
                ...
                <h2><a href="#">ADMINISTRATION</a> &raquo; <a href="#" class="active">Catégories des véhicules</a></h2>
                <div id="main"> 
<form id="form1" name="form1" method="post" action="ContCatVehicule?page=/modif1">
                          <table width="439" border="1">
                            <tr>
                              <td width="41">&nbsp;</td>
                              <td width="140"><strong>Catégorie</strong></td>
                              <td width="577"><strong>Prix de location par jour</strong></td>
                            </tr>
                  <%
	...
	%>          
		...
		%>
                          ...
                          <p>
                            <label>
                            <input type="submit" name="nouveau" id="nouveau" value="Nouvelle catégorie" />
                            </label>
                            <label>
